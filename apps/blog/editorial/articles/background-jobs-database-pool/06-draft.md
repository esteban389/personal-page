# Our Background Jobs Exhausted the Database Pool. Then the API Stopped Working.

<!-- Editorial draft, revised 2026-09-10. Incident evidence and commit findings supplied by Esteban. Java sketches are incomplete and illustrative. -->
